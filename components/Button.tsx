	...
	return (
		<button
			className={`ease group relative z-30 box-border inline-flex ${
				width || 'w-auto'
			} ${padding} cursor-pointer items-center justify-center overflow-hidden rounded bg-[#35383C] px-8 py-3 font-bold text-white transition-all duration-300 focus:outline-none`}
			onClick={onClick}
			type='button'
		>
